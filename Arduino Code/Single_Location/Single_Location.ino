...
static const float DEST_LATITUDE = -36.828122;
static const float DEST_LONGITUDE = 174.808094;
static const int RADIUS = 500; //meters for dest 4
...
static const int DEF_ATTEMPT_MAX = 10;
  ...
  if(nss.available() && tinygps.encode(nss.read()))
  {
    ...
    if (fix_age != TinyGPS::GPS_INVALID_AGE)
    {
      ...
      if(distance_meters <= RADIUS)
        ...
        lcd.clear();
        Msg(lcd, "Problem Solved", "Access Granted", 3000);
